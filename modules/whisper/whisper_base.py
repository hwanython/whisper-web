...
from modules.utils.subtitle_manager import get_srt, get_vtt, get_txt, write_file, safe_filename, srt_string_to_csv
...
class WhisperBase(ABC):
    ...
    def transcribe_file(self,
        ...
        file_format: str
            Subtitle File format to write from gr.Dropdown(). Supported format: [SRT, WebVTT, txt, csv]
        add_timestamp: bool
    ...
    def generate_and_write_file(file_name: str,
        ...
        if file_format == "SRT":
            ...
            input_filename = os.path.basename(output_path)
            content = srt_string_to_csv(get_srt(transcribed_segments), input_filename)
            output_path += '.csv'
            


            write_file(content, output_path, encoding='cp949')
