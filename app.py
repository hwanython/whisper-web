...
class App:
    ...
    def create_whisper_parameters(self):
        with gr.Row():
            ...
            dd_file_format = gr.Dropdown(choices=["SRT", "WebVTT", "txt", "csv"], value="csv", label="File Format")
        with gr.Row():
    ...
    def launch(self):
        ...
        self.app.queue(
            ...
            # share_server_address =  args.share_server_address,
...
if __name__ == "__main__":
    # _args.server_name = "10.150.27.201"
    _args.server_name = "0.0.0.0"
    _args.server_port = 7860
    # _args.inbrowser = False
    _args.share_server_protocol = "https" 
    # _args.share_server_address = f"my-gpt-wrapper.com:7000"
    # _args.share = True
    _args.root_path = "/osstem-whisper"
    app = App(args=_args)
    app.launch()
